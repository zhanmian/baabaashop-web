  ...
  <div class="detail-container">
    ...
    <el-card shadow="never" style="margin-top: 15px">
      ...
      <div style="margin-top: 20px">
        <span class="font-small el-icon-lx-info"> 基本信息</span>
      </div>
      ...
      <div style="margin-top: 20px">
        <span class="font-small el-icon-lx-home"> 收货人信息</span>
      </div>
      <div class="table-layout">
        <el-row>
      ...
      <div style="margin-top: 20px">
        <span class="font-small el-icon-lx-goods"> 商品信息</span>
      </div>
      <el-table
        ref="orderItemTable"
        ...
        <el-table-column label="商品图片" width="120" align="center">
          <template slot-scope="scope">
            <img :src="downloadImage + scope.row.picture" style="height: 80px">
          </template>
        </el-table-column>
        ...
        <el-table-column label="价格/货号" width="auto" align="center">
          <template slot-scope="scope">
            <p>价格：￥{{scope.row.skuPrice}}</p>
            <p>货号：{{scope.row.productCode}}</p>
          </template>
        </el-table-column>
        <el-table-column label="属性" width="auto" align="center">
          <template slot-scope="scope">
            {{scope.row.productAttribute | formatProductAttr}}
          </template>
        </el-table-column>
        ...
        <el-table-column label="小计" width="120" align="center">
          <template slot-scope="scope">
            ￥{{scope.row.skuPrice*scope.row.quantity}}
          </template>
        </el-table-column>
      </el-table>
      ...
      <div style="margin-top: 60px">
        <span class="font-small el-icon-lx-recharge"> 费用信息</span>
      </div>
      <div class="table-layout">
        <el-row>
        ...
        <el-row>
          ...
          <el-col :span="8" class="table-cell">￥{{order.freight}}</el-col>
          <el-col :span="8" class="table-cell">
            <span class="color-danger">￥{{order.totalAmount+order.freight}}</span>
          </el-col>
        </el-row>
      </div>
      <div style="margin-top: 20px">
        <span class="font-small el-icon-lx-edit"> 操作信息</span>
      </div>
  ...
  export default {
    ...
    data() {
      return {
        id: null,
        order: {},
        downloadImage: 'http://localhost:8080/downloadImage?filePath=',
    ...
    created() {
      ...
      this.$axios.post('/get_order_detail/' + this.id).then(response => {
